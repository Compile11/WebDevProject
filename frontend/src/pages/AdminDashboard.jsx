...
export default function AdminDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 px-4 pb-20">
      ...
      {error && (
        <div className="bg-red-900/50 text-red-400 p-4 rounded mb-6 border border-red-800">
          {error}
        </div>
      )}
      ...
      <div className="bg-gray-300 dark:bg-gray-800 rounded-lg shadow-lg border border-gray-700 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-200 dark:bg-gray-900 text-gray-800 dark:text-gray-400 text-sm uppercase tracking-wider border-b border-gray-700">
            ...
            <tbody className="divide-y divide-gray-700">
              {filteredUsers.map((user) => (
                <tr
                  key={user._id}
                  className="dark:hover:bg-gray-700 transition-colors bg-gray-300 hover:bg-gray-200 dark:bg-gray-800"
                >
                  ...
                  <td className="p-4 text-gray-800 dark:text-gray-400 text-sm">
                    {user.email}
                  </td>
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        ...
                        className={`bg-gray-400 dark:bg-gray-900 border border-gray-700 text-sm rounded px-2 py-1 focus:outline-none focus:border-blue-500 cursor-pointer ${user.role === "admin"
                      ...
                      >
                        <option value="user" className="text-gray-300">
                          User
                        </option>
                        <option value="moderator" className="text-green-400">
                          Moderator
                        </option>
