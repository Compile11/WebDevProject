...
export default function PublicProfilePage() {
  ...
  if (isLoading)
    return (
      <div className="text-center text-gray-500 dark:text-gray-400 mt-20 animate-pulse">
        Loading Profile...
      </div>
    );
  ...
  return (
    <div className="max-w-3xl mx-auto mt-8 px-4 pb-20">
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white mb-6 transition cursor-pointer"
      >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-8 flex items-center gap-6">
        <div className="shrink-0 w-24 h-24 sm:w-32 sm:h-32">
          {profileUser.profilePic ? (
            ...
            <div className="w-full h-full rounded-full bg-blue-600 flex items-center justify-center text-5xl font-bold text-white border-4 border-gray-200 dark:border-gray-600">
        ...
        <div className="flex-1">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1 flex items-center gap-2">
            ...
            <SubscriptionBadge user={profileUser}/>
          </h2>

          <p className="text-gray-700 dark:text-gray-300 text-sm italic border-l-2 border-blue-500 pl-3 mt-3">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="space-y-4">
          {userPosts.length === 0 ? (
            ...
            userPosts.map((post) => <FeedPostCard key={post._id} post={post} />)
          )}
        </div>
      </div>
    </div>
