...
export default function FeedPostCard({ post }) {
  return (
    <Link to={`/p/${post._id}`}>
      <div className="relative w-full bg-gray-200 dark:bg-gray-700 rounded-lg p-4 my-2 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer border border-transparent hover:border-gray-300 dark:hover:border-gray-600">
