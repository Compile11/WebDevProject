    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div
          ...
          className="shrink-0 z-10 hover:opacity-80 transition-opacity"
        >
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-800 dark:text-gray-400">
            <span
              onClick={handleUserClick}
              className="hover:underline z-10 flex items-center gap-1.5"
            >
      ...
      <div className="ml-auto flex gap-2 items-center">
        ...
        {post.tags &&
          ...
          post.tags.slice(0, 2).map((tag, index) => (
            <span
              key={`${tag}-${index}`}
              className="text-[10px] bg-gray-300 dark:bg-gray-800 text-gray-800 dark:text-gray-400 px-2 py-0.5 rounded border border-gray-700"
            >
              #{tag}
            </span>
          ))}
